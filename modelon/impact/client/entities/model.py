...
RuntimeOpts = Union[RuntimeOptions, Dict[str, Any]]
CompilerOpts = Union[CompilerOptions, Dict[str, Any]]
SimOpts = Union[SimulationOptions, Dict[str, Any]]
SolverOpts = Union[SolverOptions, Dict[str, Any]]
...
class Model:
    ...
    def compile(
        ...
        runtime_options: Optional[RuntimeOpts] = None,
    ...
    def new_experiment_definition(
        ...
        *,
        ...
        compiler_log_level: str = "warning",
        runtime_options: Optional[RuntimeOpts] = None,
        solver_options: Optional[SolverOpts] = None,
        simulation_options: Optional[SimOpts] = None,
